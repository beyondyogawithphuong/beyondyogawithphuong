        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-14 items-center">
          ...
          <div className="md:col-span-3 order-2">
            ...
            <p className="text-lg text-ink-soft mb-10 leading-relaxed">
              Giải pháp điều hòa hệ thần kinh, tái tạo năng lượng gốc và phục hồi giấc ngủ sâu dành cho những người đã thử đủ cách nhưng vẫn thức dậy trong trạng thái chưa được nghỉ ngơi.
            </p>
